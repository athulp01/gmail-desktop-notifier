...
def GetMessage(service, user_id, msg_id):
	...
	notify2.Notification('New message from '+message['payload']['headers'][1]['value'], message['snippet']).show()
	if TIMESTAMP.closed is False:
		TIMESTAMP.write(message['internalDate'])
		TIMESTAMP.close()
	return message

for message in ListMessagesMatchingQuery(service, 'athul929@gmail.com', 1, 'is:unread'):
	GetMessage(service, 'athul929@gmail.com', message['id'])